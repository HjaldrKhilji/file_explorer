...
export namespace print_content{
    ...
    inline void print_content_without_pre_post_fixes_impl(dirent* data_to_print){
    ...
    inline void print_content_with_pre_post_fixes_impl(dirent* data_to_print, formated_data& format){
    ...
    inline void print_content(dirent* data_to_print, bool with_custom_format, formated_data& format){
